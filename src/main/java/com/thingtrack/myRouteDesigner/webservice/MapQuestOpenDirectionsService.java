package com.thingtrack.myRouteDesigner.webservice;
...
import com.thingtrack.myRouteDesigner.mopel.Leg;
import com.thingtrack.myRouteDesigner.mopel.Location;
import com.thingtrack.myRouteDesigner.mopel.Maneuver;
...
import com.thingtrack.myRouteDesigner.mopel.Shape;
import com.thingtrack.myRouteDesigner.mopel.Location.AdminAreaType;
import com.thingtrack.myRouteDesigner.mopel.Sign;

public final class MapQuestOpenDirectionsService extends URLConnectionRoutePlanner<Route> {
	...
	protected Route createRoute(String input, MapCoordinates... coordinates)
		...
		try {
			...
			route.setTime(routeJsonObject.getLong("time"));
			route.setFormattedTime(routeJsonObject.getString("formattedTime"));
