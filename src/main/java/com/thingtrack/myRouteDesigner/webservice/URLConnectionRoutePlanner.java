...
public abstract class URLConnectionRoutePlanner<T extends Route> {
	 ...
	 */
	protected abstract String getURL(String... addresses) throws UnsupportedEncodingException, JSONException;
	 ...
	 */
	protected abstract String getURL(MapCoordinates... coordinates) throws UnsupportedEncodingException, JSONException;
