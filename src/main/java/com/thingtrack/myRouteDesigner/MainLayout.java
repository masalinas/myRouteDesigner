...
import com.thingtrack.myRouteDesigner.ui.MarkerPanel.MarkerPaintListener;
...
public class MainLayout extends CustomComponent implements Handler {
	...
	private Route designedRoute = null;	
	...
	public MainLayout() {
        ...
        stopsVectorLayer.addListener(new VectorLayer.VectorModifiedListener() {        	
            public void vectorModified(VectorModifiedEvent event) {
            	...
            	if (markerPanel != null) {
            		...
            		geocodedLocation.setLon(vector.getPoints()[0].getLon());
            		geocodedLocation.setLat(vector.getPoints()[0].getLat());
            		
            		markerPanel.setValue(geocodedLocation);
            	}
        ...
        btnAddMarker.addListener(new ClickListener() {			
			...
			public void buttonClick(ClickEvent event) {
				...
				markerPanel.addListenerMarkerPaint(new MarkerPaintListener() {				
					@Override
					public void markerPaint(MarkerPanel.MarkerEvent event) {
						refreshRoute();
...
//		}
	...
	private HorizontalLayout buildToolbarLayout() {
		...
		auxLayout.setWidth("-1px");
		auxLayout.setHeight("-1px");
		auxLayout.setMargin(false);
		toolbarLayout.addComponent(auxLayout);
		toolbarLayout.setExpandRatio(auxLayout, 1.0f);
		...
		btnCalculateRoute.setCaption("Recalculate Route");
