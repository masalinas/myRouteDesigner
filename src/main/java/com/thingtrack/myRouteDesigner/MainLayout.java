	...
	public MainLayout() {
        ...
        stopsVectorLayer.addListener(new VectorLayer.VectorModifiedListener() {        	
            public void vectorModified(VectorModifiedEvent event) {
            	...
            	if (markerPanel != null) {
            		markerPanel.serLongitude(Math.round(vector.getPoints()[0].getLon() * 100000.0) / 100000.0);
            		markerPanel.serLatitude(Math.round(vector.getPoints()[0].getLat() * 100000.0) / 100000.0);
            	}
